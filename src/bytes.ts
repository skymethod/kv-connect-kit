...
export class ByteReader {
    ...
    async read(bytes: number): Promise<{ done: true, value: undefined } | { done: false, value: Uint8Array }> {
        ...
        if (remaining.length < bytes && this.done) return { done: true, value: undefined };
