...
export function generateNapiIndex({ napiPackageName, napiArtifactName }: { napiPackageName: string, napiArtifactName: string }) {
    return template(NAPI_FUNCTIONS, napiPackageName, napiArtifactName);
}

export const template = (napiFunctions: string[], napiPackageName: string, napiArtifactName: string) => `
/* tslint:disable */
/* eslint-disable */
/* prettier-ignore */
