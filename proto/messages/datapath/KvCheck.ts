...
export type Type = $.datapath.KvCheck;

export function getDefaultValue(): $.datapath.KvCheck {
  return {
    key: new Uint8Array(),
...
export function createValue(partialValue: Partial<$.datapath.KvCheck>): $.datapath.KvCheck {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.datapath.KvCheck): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.datapath.KvCheck {
...
export function encodeBinary(value: $.datapath.KvCheck): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.datapath.KvCheck {
  const result = getDefaultValue();
